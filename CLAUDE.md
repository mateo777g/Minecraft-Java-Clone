...
1. Leer `docs/PLAN_MENU_INICIO.md`: la tabla "Estado de las fases" dice qué fase sigue.
...
- Al terminar la fase:
  ...
  2. Actualizar su fila en la tabla de `docs/PLAN_MENU_INICIO.md` (estado, commit y qué falta probar en Windows).
